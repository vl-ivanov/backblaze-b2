...
B2.prototype.createBucket = function(argsOrBucketName, undefOrBucketType, bucketInfo) {
    return actions.bucket.create(this, argsOrBucketName, undefOrBucketType, bucketInfo);
};
...
B2.prototype.updateBucket = function(argsOrBucketId, undefOrBucketType, bucketInfo) {
    return actions.bucket.update(this, argsOrBucketId, undefOrBucketType, bucketInfo);
};
